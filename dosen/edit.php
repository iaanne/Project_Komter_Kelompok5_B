...
if($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    try {
        $sql = "UPDATE dosen SET nama = :nama, alamat = :alamat WHERE nip = :nip";
        $stmt = $pdo->prepare($sql);
        $stmt->execute([
            ':nama' => $nama,
            ':alamat' => $alamat,
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST">
                            <div class="mb-3">
                                <label>NIP</label>
                                <input type="text" class="form-control" value="<?= $dsn['nip'] ?>" disabled>
                            </div>
                            <div class="mb-3">
                                <label>Nama</label>
                            ...
                            <div class="mb-3">
                                <label>Alamat</label>
                                <textarea name="alamat" class="form-control" required rows="3"><?= $dsn['alamat'] ?></textarea>
                            </div>
